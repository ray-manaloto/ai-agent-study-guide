...
### 1. vercel-labs/skills (PRIMARY TOOL)

**What it does**: CLI for installing, managing, and creating Agent Skills across 36+ AI coding tools.

**Stars**: 3.7k | **Forks**: 293
...
- Amp, Cline, CodeBuddy, Command Code, and 20+ more
...
**Commands**:
```bash
npx opensrc zod              # Fetch source for zod
...
### 4. vercel-labs/skills-handler (Server-Side)
...
### 5. vercel-labs/specli (API Specific)
...
### 6. vercel-labs/awesome-ai (Different Purpose)
...
### 7. vercel-labs/migration-skills (Reference)
...
1. **npx skills** - Complete CLI for skill management (3.7k stars)
2. **Agent Skills spec** - Open standard adopted by 26+ tools
3. **opensrc** - Library source fetching for AI context
4. **skills-handler** - Server-side skill serving (if needed)
